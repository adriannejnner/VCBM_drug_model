...
public:
    ...
    int gage, page;
    double p_0, dmax, p_psc, EC50, gamma, eta;

    Params(double p_0, double p_psc, double dmax, int gage, int page, double EC50, double gamma, double eta)
    {
        this->p_0 = p_0;
        this->p_psc = p_psc;
        this->dmax = dmax;
...
//const double Params::gamma = 1e-5;
