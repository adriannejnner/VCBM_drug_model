...
libDef.OutputFolder = "C:\Users\jenner2\OneDrive - Queensland University of Technology\Documents\2021\Polymer\Izzy\TumourModelFibreCPP_exponentialrelease";
libDef.Libraries = "";
...
% C++ Signature: Params::Params(double p_0,double p_psc,double dmax,int gage,int page,double EC50,double gamma)
ParamsConstructor1Definition = addConstructor(ParamsDefinition, ...
    "Params::Params(double p_0,double p_psc,double dmax,int gage,int page,double EC50,double gamma)", ...
...
% C++ Signature: Pancreas * SeedAndGrowToStartVolumeM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double startVolume)
SeedAndGrowToStartVolumeMDefinition = addFunction(libDef, ...
   "Pancreas * SeedAndGrowToStartVolumeM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double startVolume)", ...
...
% C++ Signature: void SimulateWholeExperimentM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double startVolume,int timeSteps,double [] volumes)
SimulateWholeExperimentMDefinition = addFunction(libDef, ...
   "void SimulateWholeExperimentM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double startVolume,int timeSteps,double [] volumes)", ...
...
% C++ Signature: void PerformMultipleRunsM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double startVolume,int timeSteps,int iterations,double [] volumes)
PerformMultipleRunsMDefinition = addFunction(libDef, ...
   "void PerformMultipleRunsM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double startVolume,int timeSteps,int iterations,double [] volumes)", ...
...
% C++ Signature: Pancreas * CreateNewParticle(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,Pancreas * pancreas)
CreateNewParticleDefinition = addFunction(libDef, ...
   "Pancreas * CreateNewParticle(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,Pancreas * pancreas)", ...
