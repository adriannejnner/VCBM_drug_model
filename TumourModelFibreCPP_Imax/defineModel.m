...
libDef.OutputFolder = "C:\Users\jenner2\OneDrive - Queensland University of Technology\Documents\2021\Polymer\Izzy\TumourModelFibreCPP_Imax";
libDef.Libraries = "";
...
% C++ Signature: Params::Params(double p_0,double p_psc,double dmax,int gage,int page,double EC50,double gamma,double eta)
ParamsConstructor1Definition = addConstructor(ParamsDefinition, ...
    "Params::Params(double p_0,double p_psc,double dmax,int gage,int page,double EC50,double gamma,double eta)", ...
...
defineArgument(ParamsConstructor1Definition, "gamma", "double");
defineArgument(ParamsConstructor1Definition, "eta", "double");
...
%% C++ class public data member |gamma| for C++ class |Params| 
% C++ Signature: double Params::gamma
addProperty(ParamsDefinition, "gamma", "double", ...
    "Description", "double    Data member of C++ class Params."); % Modify help description values as needed.

%% C++ class public data member |eta| for C++ class |Params| 
% C++ Signature: double Params::eta
addProperty(ParamsDefinition, "eta", "double", ...
    "Description", "double    Data member of C++ class Params."); % Modify help description values as needed.
...
% C++ Signature: Pancreas * SeedAndGrowToStartVolumeM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,double startVolume)
SeedAndGrowToStartVolumeMDefinition = addFunction(libDef, ...
   "Pancreas * SeedAndGrowToStartVolumeM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,double startVolume)", ...
...
defineArgument(SeedAndGrowToStartVolumeMDefinition, "gamma", "double");
defineArgument(SeedAndGrowToStartVolumeMDefinition, "eta", "double");
...
% C++ Signature: void SimulateWholeExperimentM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,double startVolume,int timeSteps,double [] volumes)
SimulateWholeExperimentMDefinition = addFunction(libDef, ...
   "void SimulateWholeExperimentM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,double startVolume,int timeSteps,double [] volumes)", ...
...
defineArgument(SimulateWholeExperimentMDefinition, "gamma", "double");
defineArgument(SimulateWholeExperimentMDefinition, "eta", "double");
...
% C++ Signature: void PerformMultipleRunsM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,double startVolume,int timeSteps,int iterations,double [] volumes)
PerformMultipleRunsMDefinition = addFunction(libDef, ...
   "void PerformMultipleRunsM(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,double startVolume,int timeSteps,int iterations,double [] volumes)", ...
...
defineArgument(PerformMultipleRunsMDefinition, "gamma", "double");
defineArgument(PerformMultipleRunsMDefinition, "eta", "double");
...
% C++ Signature: Pancreas * CreateNewParticle(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,Pancreas * pancreas)
CreateNewParticleDefinition = addFunction(libDef, ...
   "Pancreas * CreateNewParticle(double p0,double psc,int dmax,int gage,int page,double EC50,double gamma,double eta,Pancreas * pancreas)", ...
...
defineArgument(CreateNewParticleDefinition, "gamma", "double");
defineArgument(CreateNewParticleDefinition, "eta", "double");
