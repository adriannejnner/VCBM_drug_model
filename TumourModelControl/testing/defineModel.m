...
libDef.OutputFolder = "C:\Users\adria\GBM_oHSV1_app\GBM_oHSV1_app\VCBM_drug_model\TumourModelControl\testing";
libDef.Libraries = "";
...
%defineOutput(SeedAndGrowToStartVolumeDefinition, "RetVal", "clib.Model.Pancreas", <SHAPE>);
...
%defineArgument(CreateNewParticleDefinition, "pancreas", "clib.Model.Pancreas", "input", <SHAPE>); % '<MLTYPE>' can be clib.Model.Pancreas, or clib.array.Model.Pancreas
%defineOutput(CreateNewParticleDefinition, "RetVal", "clib.Model.Pancreas", <SHAPE>);
%validate(CreateNewParticleDefinition);
